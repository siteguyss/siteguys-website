...
export default function PackagesSection() {
  return (
    <section id="packages" aria-labelledby="packages-heading" className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8 grid-surface">
      <div className="mx-auto max-w-7xl mt-6 border-b-2 border-(--ink) pb-10">
        <SectionEyebrow>03/ Our Packages</SectionEyebrow>
        <h2 id="packages-heading" className="my-4 max-w-2xl text-3xl font-extrabold tracking-tight sm:text-4xl">
