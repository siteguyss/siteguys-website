    ...
    return (
      <div id="contact" className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8 grid-surface">
        <div className="mx-auto max-w-2xl">
          <SectionEyebrow>04/ You're In</SectionEyebrow>
  ...
  return (
    <div id="contact" className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8 grid-surface">
      <div className="mx-auto max-w-3xl">
        <SectionEyebrow>04/ Start a Project</SectionEyebrow>
        <h2 className="my-4 text-3xl font-extrabold tracking-tight sm:text-4xl">Tell us about the project.</h2>
        <p className="max-w-xl text-sm text-muted">Tell us what you're building. We'll review your project and come back with the right next step within 24 business hours.</p>
          ...
          <HardCard className="mt-8 space-y-6 bg-panel p-6 sm:p-8">
            ...
            {selectedPlan && totalCommitment !== null && (
              <div className="border-2 border-line bg-paper p-3.5 text-xs text-ink shadow-[3px_3px_0px_var(--line)]">
                <span className="font-mono font-black uppercase">{selectedPlan.name} selected:</span> {selectedPlan.upfrontFee.toLocaleString("en-US")} kr. upfront + {selectedPlan.monthlySupportFee.toLocaleString("en-US")} kr./mo × {selectedPlan.supportCommitmentMonths} months
                {" = "}
                {totalCommitment.toLocaleString("en-US")} kr. total 3-month commitment.
              </div>
            )}
